...
Physics.play est un jeu vidéo qui vous propose de résoudre des casse-têtes ou de jouer à des petits mini-jeux chacun basé sur un principe de la physique, le tout avec une simulation la plus fidèle possible
...
- **OS:** Windows ≥ 10 || Linux (testé à partir de Debian 13 *=> kernel version ≥6*)
- **Python:** `≥ 3.12`
- **OpenGL:** `4.+`
